...
namespace TBaltaks.FMODAudioManager.Runtime
{
    ...
    public class AudioManager : MonoBehaviour
    {
        ...
        {
            foreach (int key in eventInstances.Keys)
            {
        ...
        public void PlayOneShot(EventReference reference, GameObject emitter)
        {
            RuntimeManager.PlayOneShotAttached(reference, emitter);
        }
