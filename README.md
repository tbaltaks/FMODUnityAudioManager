...
## Installation (url)
* In Unity: Window → Package Manager → Add package from gitURL → paste `https://github.com/tbaltaks/fmodUnityAudioManager`.

## Installation (local)
* Copy the `fmodUnityAudioManager` folder into your project `Packages/` directory

OR

* In Unity: Window → Package Manager → Add package from disk → select `fmodUnityAudioManager/package.json`.
