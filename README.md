...
## Installation
* In Unity: Window → Package Manager → Add package from gitURL → paste `https://github.com/tbaltaks/FMODUnityAudioManager.git?path=/Assets/Plugins/FMODUnityAudioManager`.
